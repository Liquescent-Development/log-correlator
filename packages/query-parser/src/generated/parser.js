...
function peg$parse(input, options) {
  ...
  var peg$c15 = "unless";
  var peg$c16 = "within";
  var peg$c17 = "ignoring";
  var peg$c18 = "group_left";
  var peg$c19 = "group_right";
  var peg$c20 = "s";
  var peg$c21 = "m";
  var peg$c22 = "h";
  var peg$c23 = "d";
  ...
  var peg$e15 = peg$literalExpectation("unless", false);
  var peg$e16 = peg$literalExpectation("within", false);
  var peg$e17 = peg$literalExpectation("ignoring", false);
  var peg$e18 = peg$literalExpectation("group_left", false);
  var peg$e19 = peg$literalExpectation("group_right", false);
  var peg$e20 = peg$literalExpectation("s", false);
  var peg$e21 = peg$literalExpectation("m", false);
  ...
  var peg$f5 = function(matchers) {
      return {
        text: matchers.map(m => m.text).join(','),
        parsed: { type: 'graylog', matchers }
      };
    };
  var peg$f6 = function(metric, matchers) {
      return {
  ...
  var peg$f8 = function(label, op, value) {
      return {
  ...
  var peg$f10 = function(field, value) {
      return {
        text: `${field}:${value}`,
        parsed: { field, value }
      };
    };
  var peg$f11 = function(s) { return { raw: s.raw, value: s.value }; };
  var peg$f12 = function(i) { return { raw: i, value: i }; };
  var peg$f13 = function() { return text(); };
  var peg$f14 = function(type, keys, modifiers) {
      const result = {
        type,
        keys: keys.keys,
  ...
  var peg$f18 = function(duration) {
      return { temporal: duration };
    };
  var peg$f19 = function(labels) {
      return { ignoring: labels };
    };
  var peg$f20 = function(group) {
      return { grouping: group };
    };
  var peg$f21 = function(side, labels) {
      return { side, labels: labels || [] };
    };
  var peg$f22 = function(side) {
      return { side, labels: [] };
    };
  var peg$f23 = function() { return 'left'; };
  var peg$f24 = function() { return 'right'; };
  var peg$f25 = function(first, rest) {
      return [first, ...rest.map(r => r[3])];
    };
  var peg$f26 = function(matchers) {
      return `{${matchers.map(m => m.text).join(',')}}`;
    };
  var peg$f27 = function(num, unit) { return num + unit; };
  ...
  function peg$parseGraylogSelector() {
    ...
    s0 = peg$currPos;
    s1 = peg$parseGraylogMatcherList();
    if (s1 !== peg$FAILED) {
      peg$savedPos = s0;
      s1 = peg$f5(s1);
    }
  ...
  function peg$parseGraylogMatcherList() {
    var s0, s1, s2, s3, s4, s5, s6, s7;

    s0 = peg$currPos;
    s1 = peg$parseGraylogMatcher();
    if (s1 !== peg$FAILED) {
      s2 = [];
      s3 = peg$currPos;
      s4 = peg$parse_();
  ...
  function peg$parseGraylogMatcher() {
    var s0, s1, s2, s3, s4, s5;

...
describe('PromQLAdapter', () => {
  ...
  describe('Error handling', () => {
    ...
    it('should handle HTTP error responses', async () => {
      ...
      await expect(streamIterator.next()).rejects.toThrow(CorrelationError);
      await expect(streamIterator.next()).rejects.toThrow('Prometheus query failed: Bad Request');
    });
    ...
    it('should handle network errors', async () => {
      ...
      await expect(streamIterator.next()).rejects.toThrow('Network error');
    });
    ...
    it('should handle malformed JSON responses', async () => {
      ...
      await expect(streamIterator.next()).rejects.toThrow('Invalid JSON');
    });
